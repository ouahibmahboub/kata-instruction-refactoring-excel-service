...
public class ExportCampaignServiceTest {
    ...
    @Mock
    private CampaignClientService campaignClientServiceMock;
    ...
    public void init() {
        ...
        service = new ExportCampaignService(campaignClientServiceMock, mailServiceMock);
    ...
    public void test() {
        ...
        Mockito.doReturn(campaign).when(campaignClientServiceMock).compaing(Mockito.anyString());
